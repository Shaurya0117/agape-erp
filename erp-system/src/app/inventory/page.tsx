    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-1">
          <div className="bg-white rounded-none shadow-2xl border border-slate-200 overflow-hidden sticky top-24">
        ...
        <div className="xl:col-span-2 space-y-4">
          {items.map(item => (
            <div key={item.id} className="bg-white rounded-none shadow-xl border border-slate-200 p-5 hover:border-slate-300 transition-all group flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-slate-50 rounded-none border border-slate-200 group-hover:border-emerald-500/30 group-hover:bg-emerald-500/10 transition-colors">
